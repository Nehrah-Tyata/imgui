...
bool    ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    if (major == 0 && minor == 0)
    {
        ...
        //sscanf(gl_version, "%d.%d", &major, &minor);                                      //deprecated
    ...
    */
    ...
    //strcpy(bd->GlslVersionString, glsl_version);                                          //deprecated
...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    //sscanf(bd->GlslVersionString, "#version %d", &glsl_version);                                    //deprecated
